  ...
  return (
    <main className="min-h-screen bg-[#07051A] text-white">
      ...
      <section id="quiz" className="mx-auto max-w-6xl px-4 py-12 border-t border-white/10">
        ...
        <form className="grid md:grid-cols-2 gap-4" onSubmit={(e)=>{e.preventDefault(); alert('Спасибо! Мы на связи.');}}>
          ...
          <div className="md:col-span-2 text-sm text-white/70">После отправки откроется контакт: <a className="underline" href={`https://t.me/${tg}`} target="_blank">@{tg}</a></div>
        </form>
      </section>
