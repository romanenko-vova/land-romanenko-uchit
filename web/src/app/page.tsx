...
export default function Home() {
  ...
  const reviews = [
    ...
    { name: 'Ира', text: 'Отличный репетитор, доступно объясняет материал. Если задача вызывает затруднения, то не дает сразу готовых решений, а подводит ученика к самостоятельному решению задачи. Всегда есть обратная связь. Максимально корректен в коммуникации.', avatar: '/reviews/seva.jpg' },
  ]
